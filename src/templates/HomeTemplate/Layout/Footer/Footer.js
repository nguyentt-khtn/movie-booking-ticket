...
export default function Footer(props) {
    ...
    const cinemaFooter = _.map(arrCinema, item => _.pick(item, 'tenHeThongRap', 'logo', 'maHeThongRap'))
    return (
        <footer className="py-6 dark:bg-gray-800 dark:text-gray-50 bg-gray-600">
                ...
                <div className="grid grid-cols-12">
                    <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start">
                            <img className='mt-4' src='https://cyberlearn.vn/wp-content/uploads/2020/03/cyberlearn-min-new-opt2.png' alt='cyberlearn.vn' />
                    ...
                    <div className="col-span-6 text-center md:text-left md:col-span-3">
                        <p className="pb-1 text-lg font-medium text-center text-white">Đối tác</p>
                        <ul className='grid grid-cols-2 gap-4'>
                            {cinemaFooter?.map((cinema, index)=>{
                                return <li key={index}>
                                    <img className='w-16 h-16 ' src={cinema.logo} alt={cinema.tenHeThongRap} />
                                </li>
                            })}
                        </ul>
                    </div>
                    <div className="col-span-6 text-center md:text-left md:col-span-3 ml-32">
